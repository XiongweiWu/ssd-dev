...
elif args.version == 'AR_base_vgg':
    from models.AR_base_Net_vgg import build_net
...
# initialize newly added layers' weights with kaiming_normal method
    ...
    if 'AR' in args.version:
        net.conv1x1.apply(weights_init)
        net.conv3x3.apply(weights_init)
        net.conv5x5.apply(weights_init)
        net.weight.apply(weights_init)
